...
public final class SwipeLabelView: UIView, DayViewStateUpdating {
    ...
    private func updateLabelText() {
        labels.first!.text = formattedDate(date: selectedDate)
    }
    ...
    private var style = CalendarStyle.SwipeLabel()
    ...
    public func updateStyle(_ newStyle: CalendarStyle.SwipeLabel) {
        style = newStyle
